...
export interface ApiChannelChannel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    channelData: Schema.Attribute.JSON;
    channelId: Schema.Attribute.UID;
    channelLastFetched: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPlaylistPlaylist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    playlistId: Schema.Attribute.UID;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    url: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    youtube_api_data: Schema.Attribute.JSON;
    youtube_api_last_fetch: Schema.Attribute.DateTime;
  };
}
